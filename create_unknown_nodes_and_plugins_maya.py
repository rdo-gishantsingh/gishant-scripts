...
'''
        ...
        try:
            ...
            print(f"   Imported file with unknown plugin requirements")
...
def cleanup_scene():
    ...
    if not unknown_nodes:
        ...
        try:
            ...
            print(f"   Successfully deleted the unknown nodes.")
        except Exception as e:
    ...
    test_transforms = cmds.ls("testUnknownNode_*", "directUnknown_*", "customUnknown_*", "test_*_node", "unknownPluginTest:*", type='transform') or []
    if test_transforms:
        try:
